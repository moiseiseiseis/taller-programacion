...
// 3. Configurar fuente monoespaciada (estética terminal)
...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      ...
      <body 
        className={`${lora.variable} ${montserrat.variable} ${jetbrainsMono.variable} font-serif bg-brand-terminal text-brand-dark antialiased flex flex-col min-h-screen`}
      >
